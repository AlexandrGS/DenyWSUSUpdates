...
$DenyUpdatesPatterns = 
    ...
    "*Embedded*",
    "*kb5016892*",
    "*Windows Server 2008*02 2020*",
    "*Windows Server 2008*03 2020*",
    "*Windows Server 2008*04 2020*",
    "*Windows Server 2008*05 2020*",
    "*Windows Server 2008*06 2020*",
    "*Windows Server 2008*07 2020*",
    "*Windows Server 2008*08 2020*",
    "*Windows Server 2008*09 2020*",
    "*Windows Server 2008*10 2020*",
    "*Windows Server 2008*11 2020*",
    "*Windows Server 2008*12 2020*",
    "*Windows Server 2008*2020-02*",
    "*Windows Server 2008*2020-03*",
    "*Windows Server 2008*2020-04*",
    "*Windows Server 2008*2020-05*",
    "*Windows Server 2008*2020-06*",
    "*Windows Server 2008*2020-07*",
    "*Windows Server 2008*2020-08*",
    "*Windows Server 2008*2020-09*",
    "*Windows Server 2008*2020-10*",
    "*Windows Server 2008*2020-11*",
    "*Windows Server 2008*2020-12*",
    "*Windows Server 2008*2021*",
    "*Windows Server 2008*2022*",
    "*Windows Server 2008*2023*",
    "*Windows Server 2008*2024*",
    "*Windows 7*02 2020*",
    "*Windows 7*03 2020*",
    "*Windows 7*04 2020*",
    "*Windows 7*05 2020*",
