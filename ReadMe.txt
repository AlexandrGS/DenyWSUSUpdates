...
"Поиск обновлений которые можно отклонять"
...
"Список обновлений которые можно отклонять. Если какие-то обновления надо оставить, добавь их шаблон в массив AlloweUpdatesPatterns"
...
"Из них подпало под шаблон " + $Script:CountPatternUpdates
